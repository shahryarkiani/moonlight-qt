...
#define SER_RUMBLEINTENSITY "rumbleintensity"
...
void StreamingPreferences::reload()
{
    ...
    rumbleIntensity = settings.value(SER_RUMBLEINTENSITY, 0.0).toFloat();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_RUMBLEINTENSITY, rumbleIntensity);
